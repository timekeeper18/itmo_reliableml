...
Успехом итерации будем считать работающий сервис с возможностью загрузить фотографию челюсти (нижней/верхней) и получить ответ об обнаружении на снимке кариеса с необходимой полнотой обнаружения.
...
|     zenodo.org       | [](https://zenodo.org/record/4907880)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
EDA показал, что данные всех датасетов очень плохо размечены, есть много неподходящих фото.
 ...
 2) Для MVP - от 500 до бесконечности изображений.
