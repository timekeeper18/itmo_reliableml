...
2. Модель должна работать с фотографиями, сделанными на камеру современного (2-3 года) смартфона. При этом разрешение камеры должно быть не меньше 5 мегапикселей, а апертура не меньше f/2.0. Для максимального удобства фотографирования зубов в режиме селфи у смартфона должна быть фронтальная камера.
