...
Результаты на графике. По оси x номер запроса. По оси y время ответа на запрос.
...
- Простои по вине провайдера облака.
- Кража/потеря данных, взломы аккаунтов, незащищенные интерфейсы и API, DDoS-атаки - и другие риски использования облачных решений.
