...
- Плюсы такой инфраструктуры:
  1. Низкая стоимость на страрте - нет необходимости сразу покупать ресурсы.
  ...
  4. Облачная инфраструктура позволяет динамически регулировать выделение ресурсов и не их избыточность на страте
...
- Работа сервиса по детекцию кариеса не предполагает хранение какой-то информации о пользователе (фото, ФИО, адрес, телефон ит.д.)
