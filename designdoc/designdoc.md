...
- Возможные пути развития проекта: Классификация различных степеней кариеса, оценка процентов видимого поражения зуба, ведение истории наблюдений и отслеживание состояния зубов в динамике, обнаружение других заболеваний полости рта.
...
В качестве данных -  изображения (фотографии зубов), одна фотография - нижняя или верхняя челюсть, сфотографированная под углом максимально близким к 90 градусам, охватывающая все зубы на этой челюсти.
### 2. Методология
